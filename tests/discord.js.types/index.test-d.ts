...
expectType<DMChannel | PartialDMChannel | NewsChannel | TextChannel | ThreadChannel>(
  TextBasedChannel,
);
expectType<
  | "DM"
...
>(GuildBasedChannel);
expectType<
  CategoryChannel | NewsChannel | StageChannel | StoreChannel | TextChannel | VoiceChannel
>(NonThreadGuildBasedChannel);
