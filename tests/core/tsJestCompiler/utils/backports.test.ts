...
import { backportJestConfig } from "../../../../src/core/tsJestCompiler/utils/backports";
...
describe("backportJestConfig", () => {
  ...
  makeTestsFor("globals.__TRANSFORM_HTML__", "globals.ts-jest.stringifyContentPathRegex", [
    true,
    false,
  ]);
  ...
  makeTestsFor("globals.ts-jest.enableTsDiagnostics", "globals.ts-jest.diagnostics", [
    true,
    false,
    "\\.spec\\.ts$",
  ]);
