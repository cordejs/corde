...
export class Migration1548891232589 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(`
      DROP TABLE IF EXISTS heroclass CASCADE;
      ...
      DROP TABLE IF EXISTS inventory_equip CASCADE;
      DROP TABLE IF EXISTS inventory_potion CASCADE;
      ...
      DROP TABLE IF EXISTS aventure_monsters CASCADE;
    `);
