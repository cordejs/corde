...
:::note
This example is only to ilustrate how this test can be used, not an real case usage of this.
We also will allow add the id of an message, in this test in the future.
:::
