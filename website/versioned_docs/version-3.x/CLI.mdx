...
id: cli
title: CLI
custom_edit_url: https://github.com/cordejs/corde/blob/master/docs/CLI.mdx
---
...
Some one of Corde's [Configuration](/docs/3.x/Configurations) options can also be specified through the CLI.
