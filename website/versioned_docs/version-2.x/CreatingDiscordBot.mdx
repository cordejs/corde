...
Bot `token` is bot used to Corde [botToken](/docs/configurations#bottesttoken) and
for [cordeBotToken](/docs/configurations#cordetesttoken). Pay attention about the
usage of each one.
