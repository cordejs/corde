...
id: cli
title: CLI
custom_edit_url: https://github.com/cordejs/corde/blob/master/website/versioned_docs/version-2.0.0/CLI.mdx
---
...
Some one of Corde's [Configuration](/docs/2.x/Configurations) options can also be specified through the CLI.
