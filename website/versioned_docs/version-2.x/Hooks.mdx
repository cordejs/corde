...
id: hooks
title: Hooks
custom_edit_url: https://github.com/lucasgmagalhaes/corde/blob/master/website/docs/hooks.md
---
...
this function is not included to closures like `group` and `test`, if you call it, this function will be included for all tests (yet).
