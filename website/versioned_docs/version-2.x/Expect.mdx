...
id: expect
title: Expect
custom_edit_url: https://github.com/cordejs/corde/blob/master/website/docs/expect.md
---
...
:::note
If for some reason you what to pass the bot prefix in `expect`, do not use the config variable [prefix](/docs/2.x/configurations#botprefix).
:::
...
### toRenameRole(string, RoleIdentifier)
...
### toSetRolePermission(string | RoleIdentifier, RolePermission | RolePermission[])
