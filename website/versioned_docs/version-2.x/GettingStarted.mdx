...
custom_edit_url: https://github.com/cordejs/corde/blob/master/website/versioned_docs/version-2.0.0/GettingStarted.md
slug: /
---
...
This command will create the `corde.config.json` file in the root of your project. For more details about the `init` command
