...
Corde's configuration can be defined through a `corde.config.js|json|ts|cjs` file. This file must be at the root of your application,
...
:::note
`cordeBotToken` can be found in [Discord Developers portal](https://discord.com/developers/applications)
:::
